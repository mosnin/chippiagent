...
def _profile_user_agent() -> str:
    """Return a ``chippi-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from chippi_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"chippi-cli/{_ver}"
    except Exception:
        return "chippi-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # chippi-cli UA so the catalog endpoint is reachable.
