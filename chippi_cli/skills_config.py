"""
Skills configuration for Chippi Agent.
`chippi skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.chippi/config.yaml under:
...
from chippi_cli.config import cfg_get, load_config, save_config
from chippi_cli.colors import Colors, color
from chippi_cli.platforms import PLATFORMS as _PLATFORMS
