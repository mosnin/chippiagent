...
Used by ``chippi profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``chippi_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Chippi Agent kanban board.
...
Rules:
  ...
  - Never write "Chippi Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_chippi_home())
        else:
