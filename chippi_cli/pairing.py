...
Usage:
    chippi pairing list              # Show all pending + approved users
    chippi pairing approve <platform> <code>  # Approve a pairing code
    chippi pairing revoke <platform> <user_id> # Revoke user access
    chippi pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle chippi pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: chippi pairing {list|approve|revoke|clear-pending}")
        print("Run 'chippi pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.chippi/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'chippi pairing list' to see pending codes.\n")
