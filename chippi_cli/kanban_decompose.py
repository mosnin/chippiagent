...
Invoked by ``chippi kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Chippi Agent board.
...
def _profile_author() -> str:
    """Mirror of ``chippi_cli.kanban._profile_author``."""
    return (
