...
def _has_chippi_agent_browser() -> bool:
    ...
    # install.sh installs globally into $CHIPPI_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-ChippiHome", str(get_chippi_home()),
        ]
    else:
