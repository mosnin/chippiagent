#!/usr/bin/env python3
"""
SWE Runner with Chippi Trajectory Format

A runner that uses Chippi-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Chippi-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Chippi-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Chippi format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Chippi-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Chippi-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Chippi Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Chippi-Agent's built-in execution environments
    and outputs trajectories in Chippi-Agent format.
    """
    ...
    def _convert_to_chippi_format(
        ...
        """
        Convert internal message format to Chippi trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Chippi trajectory format
        trajectory = self._convert_to_chippi_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Chippi trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Chippi Trajectory Format")
    print("=" * 60)
