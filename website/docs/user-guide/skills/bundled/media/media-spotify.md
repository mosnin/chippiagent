...
Control the user's Spotify account via the Chippi Spotify toolset (7 tools). Setup guide: https://chippi-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `chippi auth spotify` again.
