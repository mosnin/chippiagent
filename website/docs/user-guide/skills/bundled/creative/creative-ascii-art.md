...
```bash
python3 -m pyfiglet "CHIPPI" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CHIPPI&font=Slant" | boxes -d stone
```
