...
```python
import sys
sys.path.insert(0, "/home/teknium/.chippi/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.chippi/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Chippi installs package this)
