...
| | |
|---|---|
| Source | Optional — install with `chippi skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Chippi Agent |
| License | MIT |
...
The script reads `~/.chippi/.env` for two optional defaults:
...
Helper script: `~/.chippi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.chippi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.chippi/.env`.
...
```bash
python3 ~/.chippi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.chippi/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
