...
| | |
|---|---|
| Source | Optional — install with `chippi skills install official/health/neuroskill-bci` |
...
Connect Chippi to a running [NeuroSkill](https://neuroskill.com/) instance to read
