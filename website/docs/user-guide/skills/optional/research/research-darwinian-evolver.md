...
| | |
|---|---|
| Source | Optional — install with `chippi skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Chippi Agent |
| License | MIT |
...
import upstream classes into Chippi itself.
...
```bash
mkdir -p ~/.chippi/cache/darwinian-evolver && cd ~/.chippi/cache/darwinian-evolver
...
```bash
cd ~/.chippi/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.chippi/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.chippi/skills/research/darwinian-evolver
DE_DIR=~/.chippi/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Chippi core.
   Custom driver scripts under `~/.chippi/skills/...` are user-side and fine.
