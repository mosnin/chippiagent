...
| | |
|---|---|
| Source | Optional — install with `chippi skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Chippi Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $CHIPPI_OSINT_CACHE/icij/ (default: ~/.cache/chippi-osint/icij/).
...
# Set CHIPPI_OSINT_UA=your-app/1.0 (your@email) to identify yourself
