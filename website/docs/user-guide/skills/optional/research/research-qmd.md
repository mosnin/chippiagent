...
| | |
|---|---|
| Source | Optional — install with `chippi skills install official/research/qmd` |
...
Chippi Agent via the native MCP client. This is the preferred
...
Then configure Chippi Agent to connect via HTTP:
