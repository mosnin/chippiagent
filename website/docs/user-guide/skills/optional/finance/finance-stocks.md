...
| | |
|---|---|
| Source | Optional — install with `chippi skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Chippi Agent |
| License | MIT |
...
```
SCRIPT=~/.chippi/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.chippi/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
