...
- User wants **Chippi itself to drive a browser** → use Chippi' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
