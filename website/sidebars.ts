...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-chippi-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-debugging-chippi-tui-commands',
                    'user-guide/skills/bundled/software-development/software-development-chippi-agent-skill-authoring',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-chippi-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-chippi',
        'guides/use-soul-with-chippi',
        'guides/use-voice-mode-with-chippi',
        'guides/build-a-chippi-plugin',
