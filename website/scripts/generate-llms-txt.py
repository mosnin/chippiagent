#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Chippi docs site.
...
Both publish at:
  https://chippi-agent.nousresearch.com/docs/llms.txt
  https://chippi-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://chippi-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Chippi as a Python Library", None),
        ("guides/use-mcp-with-chippi", "Use MCP with Chippi", None),
        ("guides/use-voice-mode-with-chippi", "Use Voice Mode with Chippi", None),
        ("guides/use-soul-with-chippi", "Use SOUL.md with Chippi", None),
        ("guides/build-a-chippi-plugin", "Build a Chippi Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Chippi"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "chippi-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/chippi-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Chippi Agent — Full Documentation\n",
        (
            "This file is the entire Chippi Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Chippi, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://chippi-agent.nousresearch.com/docs\n",
        "Short index: https://chippi-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
