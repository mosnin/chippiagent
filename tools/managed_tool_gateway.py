...
def auth_json_path():
    """Return the Chippi auth store path, respecting CHIPPI_HOME overrides."""
    return get_chippi_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from chippi_cli.auth import resolve_nous_access_token
