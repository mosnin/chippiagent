...
Trust levels:
  - builtin:   Ships with Chippi. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.chippi/\.env|\~/\.chippi/\.env',
     "chippi_env_access", "critical", "exfiltration",
     "directly references Chippi secrets file"),
    ...
    (r'\.chippi/config\.yaml|\.chippi/SOUL\.md',
     "chippi_config_mod", "critical", "persistence",
     "references Chippi configuration files directly"),
