...
the get_anchored_view / get_messages_around primitives in chippi_state.
...
# Third-party integrations tag their sessions with CHIPPI_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from chippi_state import DEFAULT_DB_PATH
