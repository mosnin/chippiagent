...
const STORAGE_KEY = "chippi-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `chippi_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "chippi-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-chippi-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-chippi-theme-font", "true");
