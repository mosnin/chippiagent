 ...
 * `window.__CHIPPI_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Chippi brand in the top bar
 ...
 *  `window.__CHIPPI_PLUGINS__.registerSlot(...)`.
 *
