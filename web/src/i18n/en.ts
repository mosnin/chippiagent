...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateChippi: "Update Chippi",
    updatingChippi: "Updating Chippi…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Chippi plugins (`chippi plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.chippi/plugins/?",
    removeHint: "Only user-installed plugins under ~/.chippi/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.chippi/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Chippi badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Chippi session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Chippi more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Chippi sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Chippi is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
