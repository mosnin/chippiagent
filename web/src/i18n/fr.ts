...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateChippi: "Mettre à jour Chippi",
    updatingChippi: "Mise à jour de Chippi…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Chippi (parité avec `chippi plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.chippi/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.chippi/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.chippi/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Chippi Achievements",
      subtitle:
        "Badges Chippi à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Chippi en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Chippi davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Chippi détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Chippi analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Chippi Agent ☤",
    },
  },
  kanban: {
