# Streaming LLM Response Support for Chippi Agent
...
```
CHIPPI_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CHIPPI_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `chippi_cli/config.py` | 1 | +streaming config defaults |
