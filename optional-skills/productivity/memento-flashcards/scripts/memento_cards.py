...
Data file: $CHIPPI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CHIPPI_HOME = Path(os.environ.get("CHIPPI_HOME", Path.home() / ".chippi"))
DATA_DIR = _CHIPPI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
