...
VERSION_FILE = REPO_ROOT / "chippi_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "chippi@marian.local": "Schrotti77",
    ...
    "274096618+chippi-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "chippi@nousresearch.com": "NousResearch",
    ...
    "chippi@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (CHIPPI_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (CHIPPI_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: chippi-eval community link)
    ...
    "chippiagent26@gmail.com": "chippiagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+chippiagent26@users.noreply.github.com": "chippiagent26",
    ...
    "vigo@chippi": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.chippi@agentmail.to": "oseftg",
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"chippi-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "chippi@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/chippi-agent",
    ...
    lines.append(f"# Chippi Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Chippi Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Chippi Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Chippi Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Chippi Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Chippi Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Chippi Agent v{new_version} ({calver_date})' "
