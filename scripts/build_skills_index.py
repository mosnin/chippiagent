#!/usr/bin/env python3
"""Build the Chippi Skills Index — a centralized JSON catalog of all skills.
...
`chippi skills search/install` can use it without hitting the GitHub API.
...
# Ensure CHIPPI_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Chippi Skills Index...", flush=True)
