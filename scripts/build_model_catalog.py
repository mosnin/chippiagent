#!/usr/bin/env python3
"""Build the Chippi Model Catalog — a centralized JSON manifest of curated models.
...
Chippi CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Chippi release.
...
# Ensure CHIPPI_HOME is set for imports that touch it at module level.
os.environ.setdefault("CHIPPI_HOME", os.path.join(os.path.expanduser("~"), ".chippi"))

from chippi_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "chippi-agent repo",
            "docs": "https://chippi-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
