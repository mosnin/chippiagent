...
DEFAULT_DATASETS = [
    ...
    "NousResearch/chippi-agent-megascience-sft1",
    "NousResearch/Chippi-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Chippi-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-chippi-agent"
]
