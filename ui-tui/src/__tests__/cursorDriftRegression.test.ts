 ...
 *
 * Symptom: in `chippi --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@chippi/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using chippi --tui and as i type multiline my caret at the end will often ' +
