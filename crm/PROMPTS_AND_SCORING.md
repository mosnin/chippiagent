...
| API endpoint | `app/api/ai/task/route.ts` | Authenticated task-based assistant endpoint. Tools execute in the same stream — Chippi sends and acts. See `docs/AI_AGENT_SPEC.md` for the full protocol. |
