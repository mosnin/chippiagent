...
| API endpoint | `app/api/ai/task/route.ts` | Authenticated task-based assistant endpoint (historical: previously `app/api/ai/chat/route.ts` — that route has been removed). See `docs/AI_AGENT_SPEC.md` for the full protocol. |
