...
经纪人的客户簿——联系人、线索、交易、看房、房源、申请——就是工作空间。Chippi 是一个自主 AI 代理，在这个工作空间里替经纪人干活:筛选入站线索、起草并发送跟进、安排看房、推进交易、生产营销内容、并把真正需要关注的事浮出来。
...
4. **Chippi 自己动手。**发送、排程、更新工作空间，然后汇报它做了什么。它不会把活停下来等人审批。
