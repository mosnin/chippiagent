...
should be imported at the very top of every Chippi entry point
(``chippi``, ``chippi-agent``, ``chippi-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import chippi_bootstrap``
# (or ``from chippi_bootstrap import apply_windows_utf8_bootstrap``) at
