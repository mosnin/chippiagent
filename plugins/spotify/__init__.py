...
``_check_spotify_available()`` — when the user has not run ``chippi auth
spotify``, the tools remain registered (so they appear in ``chippi
...
The Spotify auth flow (``chippi auth spotify``), CLI plumbing, and docs
