"""ntfy platform adapter (Chippi plugin).
...
``plugins/platforms/ntfy/``. The Chippi plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "chippi-in"              # subscribe topic (incoming)
          publish_topic: "chippi-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``chippi cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Chippi dependency",
