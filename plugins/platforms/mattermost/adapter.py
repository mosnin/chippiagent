...
required — uses aiohttp which is already a Chippi dependency.
...
def interactive_setup() -> None:
    ...
    ``chippi_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Chippi delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # chippi_cli/setup.py::_setup_mattermost function.
