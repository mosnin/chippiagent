# Chippi Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.chippi/plugins/chippi-achievements/state.json` (existing unlock state)
  - `~/.chippi/plugins/chippi-achievements/scan_snapshot.json` (new)
  - `~/.chippi/plugins/chippi-achievements/scan_checkpoint.json` (new)
