# Chippi Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.chippi/plugins/chippi-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.chippi/plugins/chippi-achievements/scan_checkpoint.json`.
