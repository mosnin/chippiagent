...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from chippi_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CHIPPI_OVERLAYS
        overlay = CHIPPI_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify chippi doctor recognizes Xiaomi env vars."""
