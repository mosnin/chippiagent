...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (CHIPPI_OVERLAYS) — bedrock
...
class TestProviderModelIdsBedrock:
    ...
    def test_falls_back_to_static_list_when_discovery_empty(self, monkeypatch):
        ...
        from chippi_cli.models import _PROVIDER_MODELS, provider_model_ids
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via CHIPPI_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in CHIPPI_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from chippi_cli.providers import CHIPPI_OVERLAYS
        assert "bedrock" in CHIPPI_OVERLAYS

    def test_bedrock_overlay_transport(self):
        from chippi_cli.providers import CHIPPI_OVERLAYS
        assert CHIPPI_OVERLAYS["bedrock"].transport == "bedrock_converse"

    def test_bedrock_overlay_auth_type(self):
        from chippi_cli.providers import CHIPPI_OVERLAYS
        assert CHIPPI_OVERLAYS["bedrock"].auth_type == "aws_sdk"
