"""Tests for the interactive session browser (`chippi sessions browse`).
...
from chippi_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """chippi sessions browse should be parseable."""
        from chippi_cli.main import main as _main_entry
