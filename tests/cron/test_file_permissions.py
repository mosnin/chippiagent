...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("chippi_cli.config.get_config_path", return_value=config_path), \
             patch("chippi_cli.config.ensure_chippi_home"):
    ...
    def test_ensure_chippi_home_sets_0700(self):
        home = Path(self.tmpdir) / ".chippi"
        with patch("chippi_cli.config.get_chippi_home", return_value=home):
