...
def worker_loop(worker_id: int, chippi_home: str, result_file: str) -> None:
...
def reclaimer_loop(chippi_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="chippi_mixed_stress_")
    print(f"CHIPPI_HOME = {home}")
