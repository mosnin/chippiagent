"""Tests for the secret-source tracking in ``chippi_cli.env_loader``.

These cover the small public surface that lets `chippi model` / `chippi setup`
...
from chippi_cli import env_loader  # noqa: E402
