...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.chippi/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at chippi_state import time, before pytest's CHIPPI_HOME monkeypatch
    fires — the autouse fixture's CHIPPI_HOME override doesn't help here.)
    """
    import chippi_state
