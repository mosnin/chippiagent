...
def _enable_managed_nous_tools(monkeypatch):
    ...
    chippi_cli.auth and chippi_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("chippi_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("chippi_cli.models.check_nous_free_tier", lambda: False)
