...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_chippi_home_override(self, tmp_path):
        """Auth lookup should read from CHIPPI_HOME/auth.json, not ~/.chippi/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".chippi").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``chippi tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
