...
(3 SDK retries x 3 Chippi retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_chippi_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".chippi")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Chippi, ...) behind one endpoint.  A 429 can mean either:
