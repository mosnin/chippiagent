...
projection into Chippi' display, approval bridging, transcript projection into
...
"codex_app_server"`. Chippi' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("CHIPPI_KANBAN_TASK"):
            kanban_db = spawn_env.get("CHIPPI_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "CHIPPI_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("CHIPPI_HOME", os.path.expanduser("~/.chippi")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "chippi",
        client_title: str = "Chippi Agent",
