...
Config: ~/.chippi/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.chippi/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_chippi_home()`` helper (CHIPPI_HOME-aware and
...
RULES_FILE = get_chippi_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_chippi_home() / "feishu_comment_pairing.json"
