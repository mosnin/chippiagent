...
try:
    ...
    _CHIPPI_VERSION = "0.0.0"

_APP_VERSION = _CHIPPI_VERSION
_BOT_VERSION = _CHIPPI_VERSION
_YUANBAO_INSTANCE_ID = str(CHIPPI_INSTANCE_ID)  # single source: yuanbao_proto.CHIPPI_INSTANCE_ID
